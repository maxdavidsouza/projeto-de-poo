...
public class Mensagem {
	...
	@ManyToOne
	@JoinColumn
	private UsuarioCadastrado usuarioRemetente;

	public Mensagem() {
		this.dataDeEnvio = new Date();
	}
	
	public Mensagem (String remetente, String titulo, String conteudo, String destinatario) throws EmptyFieldException {
